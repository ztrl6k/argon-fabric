...
public class TextComponent {
    ...
    public void draw(DrawContext context, float x, float y, float height) {
        ...
        VapeRenderUtils.renderRoundedQuad(context, x, y, x + mc.textRenderer.getWidth(text) + 5, y + height, 5, 20, Theme.SETTINGS_HEADER);

        context.drawText(mc.textRenderer, text, (int)(x + 2), (int)(y + 2), -1, false);
    }
